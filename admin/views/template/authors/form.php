                    ...
                    <div class="white-box">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <form action="<?=base_url?>/?controller=Author&action=addSuccess" method="post" name="formAdd" id="formAdd" enctype="multipart/form-data">
                                    ...
                                    <!--                                        </div>-->
                                    <!--                                    </div>-->
                                    <button type="submit" class="btn btn-success waves-effect waves-light m-r-10" name="btn_yes">Submit</button>
