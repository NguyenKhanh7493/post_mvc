                        ...
                        <div class="entry__img-holder">
                            <a href="single-post.html">
                                <div class="thumb-container thumb-75">
                                    <img data-src="<?php base_url?>/assets/img/blog/grid_post_img_1.jpg" src="<?php base_url?>/assets/img/empty.png" class="entry__img lazyload" alt="" />
                                </div>
                            </a>
                        </div>
                ...
                <div class="col-md-6">
                    <article class="entry">
                        <div class="entry__img-holder">
                            <a href="single-post.html">
                                <div class="thumb-container thumb-75">
                                    <img data-src="<?php base_url?>/assets/img/blog/grid_post_img_2.jpg" src="<?php base_url?>/assets/img/empty.png" class="entry__img lazyload" alt="" />
                                </div>
                            </a>
                        </div>
