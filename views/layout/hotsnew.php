            ...
            <div class="entry__img-holder">
                <a href="single-post.html">
                    <div class="thumb-container thumb-75">
                        <img data-src="<?php base_url?>/admin/public/upload/test1.jpg" src="<?php base_url?>/admin/public/upload/test1.jpg" class="entry__img owl-lazy" alt="" />
                    </div>
                </a>
            </div>
                ...
                <div class="entry__header">
                    <h2 class="entry__title entry__title--sm">
                        <a href="single-post.html">
                            ...
                            The Surprising Way This Designer Picked the Next It Colors</a>
                    </h2>
